...
static const std::vector<ImageResInfo>image_info_list = {  //列表初始化+R标记 不需要对反斜杠进行转义处理
	...
	{"enemy_attack1",_T(R"(Boss\Agis_Full\260px\attack1(1).png)")},
	{"enemy_attack2",_T(R"(Boss\Agis_Full\260px\attack2(1).png)")},
	{"enemy_attack3",_T(R"(Boss\Agis_Full\260px\attack3(1).png)")},
	{"enemy_attack4",_T(R"(Boss\Agis_Full\260px\attack4(1).png)")},
	{"enemy_attack5",_T(R"(Boss\Agis_Full\260px\attack5(1).png)")},
	{"enemy_dead",_T(R"(Boss\Agis_Full\260px\death(1).png)")},
	{"enemy_idle",_T(R"(Boss\Agis_Full\260px\idle(1).png)")},
	{"enemy_teleport_out",_T(R"(Boss\Agis_Full\260px\teleport_out(1).png)")},
	{"enemy_teleport_in",_T(R"(Boss\Agis_Full\260px\teleport_in(1).png)")},



	{"enemy_attack2_vfx",_T(R"(Boss\Agis_Full\VFX2\Frames\attack2_vfx.png)"),},
...
{ 
	{"enemy_attack1_vfx",_T(R"(Boss\Agis_Full\VFX1\Frames\350px\attack1_vfx_%d(1).png)"),10},

	{"enemy_attack3_vfx",_T(R"(Boss\Agis_Full\VFX3\Frames\attack3_vfx_%d.png)"),6},

	{"enemy_attack4_vfx_left",_T(R"(Boss\Agis_Full\VFX4\Frames\attack4_vfx_%d.png)"),9},
	{"enemy_attack5_vfx_left",_T(R"(Boss\Agis_Full\VFX5\Frames\attack5_vfx_%d.png)"),11},
...
void ResourcesManager::load() {
	...
	//flip_atlas("enemy_attack4_vfx_left", "enemy_attack4_vfx_right");

	//flip_atlas("enemy_attack5_vfx_left", "enemy_attack5_vfx_right");
