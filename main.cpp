...
int main(int argc, char** argv) {
	...
	while (!is_quit) {
		...
		CharacterManager::instance()->get_player()->on_update(delta.count());
		...
		CollisionManager::instance()->get_attack1_box()->on_debug_render();
		CollisionManager::instance()->get_see_through_box_attack2()->on_debug_render();
		CollisionManager::instance()->get_see_through_box_attack3()->on_debug_render();
